...
FilzaApplySandboxExt_FILES = Tweak.m MCMBridge.m MCMFilzaIntegration.m PosterBoardFeature.m LoginViewController.m FilzaAuthGate.m FilzaAuthIntegration.m
